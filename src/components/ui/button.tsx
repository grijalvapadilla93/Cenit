...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium transition-all duration-300 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-background hover:scale-105",
        outline: "border border-white/20 text-primary hover:bg-white/10 backdrop-blur-sm",
        ghost: "text-primary/60 hover:text-primary",
      },
      size: {
        default: "px-8 py-4 rounded-full",
        sm: "px-4 py-2 rounded-full",
        lg: "px-10 py-5 rounded-full",
      },
    },
    defaultVariants: {
      variant: "default",
